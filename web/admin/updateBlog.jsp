        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Sửa đổi Blog</a></li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <form class="row" action="MainController?action=updateblog" method="Post" enctype="multipart/form-data">
                                <input type="hidden" id="blog-id" name="blog_id" value="${BlogIDDATA.blog_id}">
                                
                                <div class="form-group col-md-3">
                                    <label class="control-label">Tên Blog</label>
                                    <input class="form-control" name="update_name" type="text" value="${BlogIDDATA.blog_name}">
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" name="update_describe" id="describe" >${BlogIDDATA.blog_describe}</textarea>
                                </div>
