    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="MainController?acion=productmanager"><i
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="permission" class="form-control" id="exampleSelect1">
                                            <option value="ADMIN">Cho phép làm admin </option>
                                            <option value="STAFF">Cho phép làm staff</option>
                                            <option value="CUS">Hủy bỏ</option>
                                        </select>
                                    </div>
                                </div>
                                <BR>
