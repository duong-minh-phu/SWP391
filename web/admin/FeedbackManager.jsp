...
<html lang="en">
    ...
    <head>
        <title>Danh sách Feedback | Quản trị Admin</title>
        <meta charset="utf-8">
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>Danh sách Feedback</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                        ...
                        <div class="tile-body">
                            ...
                            <form action="MainController?action=updateproduct" method="POST" >
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    ...
                                    <tbody>
                                        <c:forEach items="${FeedBackData}" var="ratt">
                                            <tr>
                                                <td>${ratt.user_name}</td>
                                                <td>${ratt.product_id}</td>
                                                <td>${ratt.rate}</td>
                                                <td>${ratt.comment}</td>
                                                <td>${ratt.date}</td>
                                            </tr>
